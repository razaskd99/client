        ...
        {tenantData.map((item, index) => (
          <div className={`mt-0 ${item.name === 'Description' ? 'col-span-2' : ''}`} key={index + 3}>
            {item.type && item.type === 'textarea' ? (
              ...
              item.type && item.type === 'file' ? (<input type="file" id={item.name} name={item.name}
              ...
              />) : (
                <>
                  ...
                  ) : <TextField id={item.id} label={item.lebal + (item.required ? " *" : "")} variant="outlined" 
        ...
        {contactData.map((item, index) => (
          <div className={`mt-0 ${item.name === 'Description' ? 'col-span-2' : ''}`} key={index + 15}>
            ...
            {item.type && item.type === 'textarea' ? (
              ...
              <TextField id={item.name} label={item.lebal + (item.required ? " *" : "")} variant="outlined" 
                className="w-full bg-white" 
                onChange={handleChange}
              />
